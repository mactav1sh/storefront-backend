...
describe('Products - Unit Testing', () => {
  ...
  describe('Products Endpoints Testing', () => {
    ...
    it('api/users/:id Endpoint - Show product with "wrong" id should return status 404', async () => {
      const response = await request
  ...
  describe('Products - Testing results of Model methods', () => {
    ...
    it('Show product method with wrong id should return undefined', async () => {
      const response = await store.showProduct(999);
